...
class ProductTestCase(TestCase):
    ...
    def setUp(self):
        self.user_a = User.objects.create_user(
            username='testuser_a', email='test@test.com', password='abc123')
        ...
        self.inventory_order_a.items.add(
            self.inventory_order_item_a, self.inventory_order_item_b)
        ...
        self.shop_order_a.items.add(
            self.shop_order_item_a, self.shop_order_item_b)
    ...
    def test_realize_order_time(self):
        self.inventory_order_a.realize_order()
        self.assertAlmostEqual(self.inventory_order_a.realized_date, timezone.now(
